...
import { SECTIONS } from 'data/NavbarMenuSections';
import { useQuery } from 'styles/breakpoints';

const NavbarMenu: React.FC = () => {
    const { isTablet, isMobile, isSmDesktop } = useQuery();
    return (
        <FlexWrapper display={isMobile ? 'none' : 'flex'} flexGrow='1' justifyContent='space-evenly' paddingX={isSmDesktop ? 's40' : 's80'} >
